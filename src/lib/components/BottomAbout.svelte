...
<article
	class="flex flex-col gap-2 lg:gap-6 lg:flex-row-reverse lg:justify-between items-center"
>
	<enhanced:img
	...
	<div class=" flex flex-col gap-2 text-center lg:text-start text-wrap self-start lg:self-center">
		...
		<p class="mb-3 text lg:w-[25rem] font- leading-relaxed text-lg">
