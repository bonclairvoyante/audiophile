...
<main class="mx-[1.51rem] md:mx-[1em] mb-24">
	...
	>
		...
		<div class="flex flex-col gap-4 md:gap-2 lg:self-center">
			<h1 class="uppercase text-3xl lg:text-5xl font-bold">{zx7[0].name}</h1>
			<p class="text-zinc-700">
				{zx7[0].description}
			</p>
			<p class="font-bold lg:py-4">$ {zx7[0].price}</p>
			<div class="flex gap-3 lg:py-3.5 lg:justify-start">
				...
				<button
					...
					onclick={() => {
						...
						toast.success(`${zx7[0].name} added to cart!`, {
	...
	>
		...
		<div class="flex flex-col gap-3 md:gap-2">
			<div class="flex gap-x-4">
				<p class="text-orange font-bold">{zx7[0].includes[0].quantity}x</p>
				<p>{zx7[0].includes[0].item}</p>
			</div>
			<div class="flex gap-x-4">
				<p class="text-orange font-bold">{zx7[0].includes[1].quantity}x</p>
				<p>{zx7[0].includes[1].item}</p>
			</div>
			<div class="flex gap-x-4">
				<p class="text-orange font-bold">{zx7[0].includes[2].quantity}x</p>
				<p>{zx7[0].includes[2].item}</p>
			</div>
			<div class="flex gap-x-4">
				<p class="text-orange font-bold">{zx7[0].includes[3].quantity}x</p>
				<p>{zx7[0].includes[3].item}</p>
			</div>
			<div class="flex gap-x-4">
				<p class="text-orange font-bold">{zx7[0].includes[4].quantity}x</p>
				<p>{zx7[0].includes[4].item}</p>
			</div>
		</div>
	</section>
	<!-- Gallery -->
