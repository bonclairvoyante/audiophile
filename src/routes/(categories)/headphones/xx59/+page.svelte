...
<main class="mx-[1.51rem] md:mx-[1em] mb-24">
	...
	<section class="p-3 md:p-4 lg:p-5 flex flex-col md:flex-row gap-2 md:gap-4 lg:gap-10 text-start">
		<enhanced:img
			src="/src/lib/assets/product-xx59-headphones/desktop/image-product.jpg"
			class="rounded-md"
			alt="yx1-earphones"
		/>
		<div class="flex flex-col gap-4 md:gap-2 md:self-center">
			<h1 class="uppercase text-3xl lg:text-5xl font-bold">{xx59[0].name}</h1>
			<p class="text-zinc-700">
				{xx59[0].description}
			</p>
			<p class="font-bold lg:py-4">$ {xx59[0].price}</p>
			<div class="flex gap-3 lg:py-3.5 lg:justify-start">
				...
				<button
					...
					onclick={() => {
						...
						toast.success(`${xx59[0].name} added to cart!`, {
	...
	>
		...
		<div class="flex flex-col gap-3 md:gap-2">
			<div class="flex gap-x-4">
				<p class="text-orange font-bold">{xx59[0].includes[0].quantity}x</p>
				<p>{xx59[0].includes[0].item}</p>
			</div>
			<div class="flex gap-x-4">
				<p class="text-orange font-bold">{xx59[0].includes[1].quantity}x</p>
				<p>{xx59[0].includes[1].item}</p>
			</div>
			<div class="flex gap-x-4">
				<p class="text-orange font-bold">{xx59[0].includes[2].quantity}x</p>
				<p>{xx59[0].includes[2].item}</p>
			</div>
			<div class="flex gap-x-4">
				<p class="text-orange font-bold">{xx59[0].includes[3].quantity}x</p>
				<p>{xx59[0].includes[3].item}</p>
			</div>
		</div>
	</section>
	<!-- Gallery -->
	...
	>
		<div class="flex flex-col gap-2 md:gap-[1.5rem] lg:gap-[1.85rem] xl:gap-[2rem]">
			<enhanced:img
				src="/src/lib/assets/product-xx59-headphones/desktop/image-gallery-1.jpg"
				class="rounded-md"
				alt="xx59-headphones"
			/>
			<enhanced:img
				src="/src/lib/assets/product-xx59-headphones/desktop/image-gallery-2.jpg"
				class="rounded-md"
				alt="xx59-headphones"
			/>
		</div>
		<enhanced:img
			src="/src/lib/assets/product-xx59-headphones/desktop/image-gallery-3.jpg"
			class="rounded-md"
			alt="xx59-headphones"
		/>
	</section>
